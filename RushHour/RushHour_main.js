...
import {RushHour_Board,showMoves} from "./RushHour_Board.js";
import {RushHour_Display} from "./RushHour_Display.js";
...
function play(no,state){
    ...
    board = new RushHour_Board(no,state,display);
}
...
function initEventHandlers() {
    ...
    $("input[name=state-no]:first").prop("checked",true); // check first state
        ...
        $("#solve").on("mousedown",()=>
            solveWeb(problemNo,startStates[problemNo],RushHour_Board,display,showMoves));
        $("#reset").append(
